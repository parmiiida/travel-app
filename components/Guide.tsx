...
const Guide = () => {
  return (
    <section className='flex flexCenter flex-col'>
      <div className=' max-container w-full pb-24 padding-container'>
        <Image
        ...
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          <h2 className="bols-40 lg:bold-64 xl:max-w-[390px]"> Guide You to Easy Path</h2>
          <p className="regular-16 text-gray030 xl:max-w-[520px]">Only with the hilink application you will no longer get lost and get lost again,
      ...
      <div className="flexCenter max-container w-full relative">
        ...
        <div className="absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl border
          shadow-md md:left-[5%] lg:top-20">
            ...
            <Image alt="meter" width={16} height={158} src='/meter.svg'/>
