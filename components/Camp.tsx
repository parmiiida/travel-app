  ...
  return (
      ...
      <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
        ...
        <div className="gap-6 flexCenter">
          ...
          <p className="md:bold-20 bold-16 text-white">{peopleJoined}</p>
        </div>
      </div>
    </div>
  )
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20
          relative w-full overflow-hidden rounded-3xl">
            <h2 className="regular-24 md:regular-22 2xl:regular-64 text-white capitalize">
              <strong>Feeling Lost </strong>And Not Knowing The Way?
            </h2>
            <p className="regular-14 text-white xl:regular:16 mt-5">
